...
#BasePath="/atlas/data19/ksekhon/trueSWiFt"
BasePath="$PWD/../.."
...
# SWiFt background
swiftBkg=$BasePath"/output/root/data/dijet_qStar_LLHScan_limitsUncert.root"
swiftBkgName="swiftBkgBest"

# Signal spline path 
# ***** NOTE: PAY ATTENTION TO SIGNAL PICKED *****
SigPath=${BasePath}"/morphing/output/qStar_dijet"
SigFile="qStar_nominal.root"
SigJES1_1up="qStar_JES1_1up0.root"
SigJES2_1up="qStar_JES2_1up0.root"
SigJES3_1up="qStar_JES3_1up0.root"
SigJES1_1down="qStar_JES1_1down0.root"
SigJES2_1down="qStar_JES2_1down0.root"
SigJES3_1down="qStar_JES3_1down0.root"
SigType="GrLFunc" #  ******NOTE: This should be set to "GrLFunc" for q*, W', etc and "GFunc" for gaussian functions!!!!

# outputs
OutputPath="$PWD/../../condor"
OutputFolder="qStar_withSignalSys"
