...
# template config 
Config=${BasePath}"/configFiles/condor/config_TLA_PE_condor.txt" 

# SWiFt background
swiftBkg=$BasePath"/output/root/data/dataTLA06_gausRes_LLHScan.root"
swiftBkgName="swiftBkgBest"

# Signal spline path 
# ***** NOTE: PAY ATTENTION TO SIGNAL PICKED *****
SigPath=${BasePath}"/morphing/output/gaus_TLA"
